        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:pt-56">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Result Checker Portal
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
            In Marygold International School Calabar, We Educate, Inform, and Train your child/ward to be a total package to the outside World. We are the BEST!
            </p>
